...
| **Lower third for the ASG** | `INDRIKA RATWATTE` / **`UN Deputy Relief Chief a.i.`** | **`UN Deputy Relief Chief` is the standing title for the post** — it stays whoever holds it. Indrika Ratwatte is the current holder and is **acting**, so his strap carries **`a.i.`**. Drop the `a.i.` once the post is filled permanently, and swap the name when the holder changes (expected around Sep 2026). |
